...
class WXZU60 extends Base
{
    ...
    public function randomCodes()
    {
        ...
        $rand=rand(4,count($this->filterArr));
        $arr[]= implode($this->codeSep,(array)array_rand($this->filterArr,$rand));
    ...
    public function count($sCodes)
    {
        ...
        return Algorithm::getCombinCount($m,1) * Algorithm::getCombinCount($n,3) - Algorithm::getCombinCount($h,1)*Algorithm::getCombinCount($n-1,2);
    }
    ...
    public function assertLevel($levelId, $sCodes, Array $numbers)
    {
        ...
        $aP2 = Algorithm::getCombination(explode($this->codeSep, $aCodes[1]), 3);
        foreach ($aP2 as $v2) {
            $v2= str_replace(' ', '', $v2);
            $vs = str_split($v2);
            foreach ($aP1 as $v1) {
