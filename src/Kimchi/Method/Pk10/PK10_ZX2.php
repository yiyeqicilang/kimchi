...
class PK10_ZX2 extends Base
{
    ...
    {
        //格式
        if (!preg_match(sprintf('/^(((0[1-9]\%s)|(10\%s)){0,10}((0[1-9])|(10))\%s)(((0[1-9]\%s)|(10\%s)){0,10}((0[1-9])|(10)))$/',$this->codeSep,$this->codeSep,$this->lineSep,$this->codeSep,$this->codeSep), $sCodes)) {
            return false;
        }
