...
class LTZX3 extends Base
{
    ...
    {
        //格式
        if (!preg_match(sprintf('/^(((0[1-9]\%s)|(1[01]\%s)){0,10}((0[1-9])|(1[01]))\%s){2}(((0[1-9]\%s)|(1[01]\%s)){0,10}((0[1-9])|(1[01])))$/',$this->codeSep,$this->codeSep,$this->lineSep,$this->codeSep,$this->codeSep), $sCodes)) {
            return false;
        }
